...
class Analizar():
    ...
    def evaluar_manos(self):
        ...
        print(f"Frecuencias de cartas: {(frequencias)}") 
        ...
        elif len(set(carta.pica for carta in self.cartas)) == 1:
        ...
        elif self.mejor_mano == "Escalera" and len(set(carta.pica for carta in self.cartas)) == 1:
            self.mejor_mano = "Escalera de Color"
        elif self.mejor_mano == "Escalera" and set(orden) == {14, 13, 12, 11, 10}:
